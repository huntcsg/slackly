...
class DeletePhoto(BaseAPIEndpoint):
...
class GetPresence(BaseAPIEndpoint):
...
class Identity(BaseAPIEndpoint):
...
class SetActive(BaseAPIEndpoint):
...
class SetPhoto(BaseAPIEndpoint):
...
class SetPresence(BaseAPIEndpoint):
